...
function PublicPortfolioPage() {
  ...
  useEffect(() => {
    const fetchPortfolio = async () => {
      try {
        ...
        setPageError(
          error?.response?.data?.detail || "Failed to load public portfolio."
        );
      } finally {
        setLoading(false);
      }
  ...
  if (loading) {
    return <div className="loading-screen">Loading public portfolio...</div>;
  }
    ...
    return (
      <div className="loading-screen">
        <div style={{ textAlign: "center", maxWidth: "700px", padding: "20px" }}>
          <h2>Public portfolio could not be loaded</h2>
          <p>{pageError}</p>
        </div>
      </div>
    );
  ...
  const summary = safeText(
    d.summary,
    "This public portfolio is generated from resume content and organized into a cleaner professional presentation."
  );
  ...
  const heroTitle = useMemo(() => {
    if (skills.length >= 3) return `${skills[0]} • ${skills[1]} • ${skills[2]}`;
    if (skills.length > 0) return skills.join(" • ");
    return "Public portfolio generated from resume data";
  }, [skills]);
      ...
      <main className="portfolio-main">
        <section id="home" className="hero-section">
          <div className="hero-left">
            <p className="hero-kicker">Public Portfolio</p>
          ...
          <div className="hero-right">
            <div className="portrait-card">
              ...
              <p className="portrait-caption">Live portfolio</p>
            </div>
          </div>
        </section>
